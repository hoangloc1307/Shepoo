...
export default function ProductDetail() {
  ...
  const cartMutation = useMutation(purchaseApi.addToCart)
            ...
            <div className='col-span-5'>
              ...
              >
                <img
                  src={activeImage}
                  alt={product.name}
                  className='pointer-events-none absolute top-0 left-0 h-full w-full cursor-zoom-in bg-white object-cover'
                  ref={imageRef}
                />
              </div>
